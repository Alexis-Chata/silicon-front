        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <!-- info -->
                    <p class="mb-0" _msttexthash="7254286" _msthash="127">Por favor, echa un vistazo a todos los cursos
                        disponibles y compra algunos cursos que satisfagan tus necesidades.</p>
                    <!-- Button -->
                    <a href="{{ route('cursos') }}" class="btn btn-primary mt-4 mb-0" _msttexthash="285155" _msthash="128">Volver a
                        Cursos</a>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4 g-sm-5">
                ...
                <div class="col-lg-8 mb-4 mb-sm-0">
                    <div class="card card-body p-4 shadow">
                        ...
                        <div class="alert alert-danger alert-dismissible d-flex justify-content-between align-items-center fade show py-3 pe-2"
                            role="alert">
                            <div>
                                <font _mstmutation="1" _msttexthash="15229032" _msthash="126"><span class="fs-5 me-1"
                                        _mstmutation="1" _istranslated="1">🔥</span> Estos cursos tienen un descuento
                                    limitado, por favor pague dentro de<strong class="text-danger ms-1" _mstmutation="1"
                                        _istranslated="1">2 días y 18 horas</strong></font>
                            </div>
                                ...
                                <tbody class="border-top-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-lg-flex align-items-center">
                                                ...
                                                <div class="w-100px w-md-80px mb-2 mb-md-0">
                                                    <img src="silicon-front/silicon/08.jpg" class="rounded" alt="">
                                                </div>
                                                <!-- Title -->
                                                <h6 class="mb-0 ms-lg-3 mt-2 mt-lg-0">
                                                    <a href="#" _msttexthash="992043" _msthash="128">Creación de API
                                                        escalables con GraphQL</a>
                                                </h6>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <h5 class="text-success mb-0" _msttexthash="21021" _msthash="129">$ 350</h5>
                                        </td>
                                        <!-- Action item -->
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-lg-flex align-items-center">
                                                <!-- Image -->
                                                <div class="w-100px w-md-80px mb-2 mb-md-0">
                                                    <img src="silicon-front/silicon/10.jpg" class="rounded" alt="">
                                                </div>
                                                <!-- Title -->
                                                <h6 class="mb-0 ms-lg-3 mt-2 mt-lg-0">
                                                    <a href="#" _msttexthash="407810" _msthash="130">Bootstrap 5 desde
                                                        cero</a>
                                                </h6>
                                            </div>
                                        </td>
                                        ...
                                        <!-- Amount item -->
                                        <td class="text-center">
                                            <h5 class="text-success mb-0" _msttexthash="20813" _msthash="131">$ 150</h5>
                                        </td>
                                        <!-- Action item -->
                                        <td>
                                            <a href="#" class="btn btn-sm btn-success-soft px-2 me-1 mb-1 mb-md-0"><i
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card card-body p-4 shadow">
                        ...
                        <ul class="list-group list-group-borderless mb-2">
                            <li class="list-group-item px-0 d-flex justify-content-between">
                                <span class="h6 fw-light mb-0" _msttexthash="258544" _msthash="136">Precio
                                    original</span>
                                <span class="h6 fw-light mb-0 fw-bold" _msttexthash="20644" _msthash="137">$ 500</span>
                            </li>
                            <li class="list-group-item px-0 d-flex justify-content-between">
                        ...
                        <!-- Content -->
                        <p class="small mb-0 mt-2 text-center" _msttexthash="2555514" _msthash="143">Al completar su
                            compra, usted acepta estos <a href="#" _istranslated="1"><strong _istranslated="1">Términos
