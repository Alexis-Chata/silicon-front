						...
						<ul class="dropdown-menu" aria-labelledby="categoryMenu">
							...
							<li class="dropdown-submenu dropend">
								...
								<div class="dropdown-menu dropdown-menu-start dropdown-width-lg" data-bs-popper="none">
									<div class="row p-4">
										...
										<div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
											...
											<div class="d-flex mb-4 position-relative">
												<img src="./silicon-front/silicon/uni-logo-01.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<!-- Dropdown item -->
											<div class="d-flex mb-4 position-relative">
												<img src="./silicon-front/silicon/uni-logo-02.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<!-- Dropdown item -->
											<div class="d-flex mb-4 position-relative">
												<img src="./silicon-front/silicon/uni-logo-03.svg" class="icon-md" alt="">
												<div class="ms-3">
											...
											<div class="d-flex position-relative">
												<img src="./silicon-front/silicon/uni-logo-04.svg" class="icon-md" alt="">
												<div class="ms-3">
									...
									<div class="row">
										<div class="col-12">
											<div class="card bg-blue rounded-0 rounded-bottom p-3 position-relative overflow-hidden" style="background:url(silicon-front/assets/images/pattern/05.png) no-repeat center center; background-size:cover;">
												<!-- SVG decoration -->
				...
				<ul class="navbar-nav navbar-nav-scroll me-auto">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="demoMenu">
							<li> <a class="dropdown-item active" href="https://eduport.webestica.com/index.html">Home Default</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-2.html">Home Education</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-3.html">Home Academy</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-4.html">Home Course</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-5.html">Home University</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-6.html">Home Kindergarten</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-7.html">Home Landing</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-8.html">Home Tutor</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-9.html">Home School <span class="badge bg-success ms-2 smaller">New</span></a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/index-10.html">Home Abroad <span class="badge bg-success ms-2 smaller">New</span></a></li>
							<li> <hr class="dropdown-divider"></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/request-demo.html">Request a demo</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/book-class.html">Book a Class</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/request-access.html">Free Access</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/university-admission-form.html">Admission Form</a></li>
						</ul>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							...
							<li class="dropdown-submenu dropend">
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-categories.html">Course Categories <span class="badge bg-success ms-2 smaller">New</span></a></li>
									<li> <hr class="dropdown-divider"></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-grid.html">Course Grid Classic</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-grid-2.html">Course Grid Minimal</a></li>
									<li> <hr class="dropdown-divider"></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-list.html">Course List Classic</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-list-2.html">Course List Minimal</a></li>
									<li> <hr class="dropdown-divider"></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-detail.html">Course Detail Classic</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-detail-min.html">Course Detail Minimal</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-detail-adv.html">Course Detail Advance</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-video-player.html">Course Full Screen Video</a></li>
								</ul>
							</li>
							...
							<li class="dropdown-submenu dropend">
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/about.html">About Us</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/contact-us.html">Contact Us</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/blog-grid.html">Blog Grid</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/blog-masonry.html">Blog Masonry</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/blog-detail.html">Blog Detail</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/pricing.html">Pricing</a></li>
								</ul>
							</li>

							<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-list.html">Instructor List</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-single.html">Instructor Single</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/become-instructor.html">Become an Instructor</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/abroad-single.html">Abroad Single <span class="badge bg-success ms-2 smaller">New</span></a></li>
							...
							<li class="dropdown-submenu dropend">
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/shop.html">Shop grid</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/shop-product-detail.html">Product detail</a></li>
								</ul>
							</li>
							...
							<li class="dropdown-submenu dropend">
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/help-center.html">Help Center</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/help-center-detail.html">Help Center Single</a></li>
								</ul>
							</li>
							...
							<li class="dropdown-submenu dropend">
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/sign-in.html">Sign In</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/sign-up.html">Sign Up</a></li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/forgot-password.html">Forgot Password</a></li>
								</ul>
							</li>

							<li> <a class="dropdown-item" href="https://eduport.webestica.com/faq.html">FAQs</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/error-404.html">Error 404</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/coming-soon.html">Coming Soon</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/cart.html">Cart</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/checkout.html">Checkout</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/empty-cart.html">Empty Cart</a></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/wishlist.html">Wishlist</a></li>
						</ul>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="accounntMenu">
							...
							<li class="dropdown-submenu dropend">
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-dashboard.html"><i class="bi bi-grid-fill fa-fw me-1"></i>Dashboard</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-manage-course.html"><i class="bi bi-basket-fill fa-fw me-1"></i>Courses</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-create-course.html"><i class="bi bi-file-earmark-plus-fill fa-fw me-1"></i>Create Course</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/course-added.html"><i class="bi bi-file-check-fill fa-fw me-1"></i>Course Added</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-quiz.html"><i class="bi bi-question-diamond fa-fw me-1"></i>Quiz <span class="badge bg-success ms-2 smaller">New</span></a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-earning.html"><i class="fas fa-chart-line fa-fw me-1"></i>Earnings</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-studentlist.html"><i class="fas fa-user-graduate fa-fw me-1"></i>Students</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-order.html"><i class="bi bi-cart-check-fill fa-fw me-1"></i>Orders</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-review.html"><i class="bi bi-star-fill fa-fw me-1"></i>Reviews</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-payout.html"><i class="fas fa-wallet fa-fw me-1"></i>Payout</a> </li>
								</ul>
							</li>
							...
							<!-- Dropdown submenu -->
								...
								<ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/student-dashboard.html"><i class="bi bi-grid-fill fa-fw me-1"></i>Dashboard</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/student-subscription.html"><i class="bi bi-card-checklist fa-fw me-1"></i>My Subscriptions</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/student-course-list.html"><i class="bi bi-basket-fill fa-fw me-1"></i>Courses</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/student-course-resume.html"><i class="far fa-fw fa-file-alt me-1"></i>Course Resume <span class="badge bg-success ms-2 smaller">New</span></a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/student-quiz.html"><i class="bi bi-question-diamond fa-fw me-1"></i>Quiz <span class="badge bg-success ms-2 smaller">New</span></a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/student-payment-info.html"><i class="bi bi-credit-card-2-front-fill fa-fw me-1"></i>Payment Info</a> </li>
									<li> <a class="dropdown-item" href="https://eduport.webestica.com/student-bookmark.html"><i class="fas bi-cart-check-fill fa-fw me-1"></i>Wishlist</a> </li>
								</ul>
							</li>

							<li> <a class="dropdown-item" href="https://eduport.webestica.com/admin-dashboard.html"><i class="fas fa-user-cog fa-fw me-1"></i>Admin</a> </li>
							<li> <hr class="dropdown-divider"></li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-edit-profile.html"><i class="fas fa-fw fa-edit me-1"></i>Edit Profile</a> </li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-setting.html"><i class="fas fa-fw fa-cog me-1"></i>Settings</a> </li>
							<li> <a class="dropdown-item" href="https://eduport.webestica.com/instructor-delete-account.html"><i class="fas fa-fw fa-trash-alt me-1"></i>Delete Profile</a> </li>
								...
								<div class="col-xl-6 col-xxl-3">
									...
									<div class="row g-2 justify-content-center mt-3">
										...
										<div class="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="./silicon-front/silicon/google-play.svg" class="btn-transition" alt="google-store"> </a>
										</div>
										<!-- App store button -->
										<div class="col-6 col-sm-4 col-xxl-6">
											<a href="#"> <img src="./silicon-front/silicon/app-store.svg" class="btn-transition" alt="app-store"> </a>
										</div>
									</div>
								</div>
								...
								<div class="col-12">
									<div class="alert alert-success alert-dismissible fade show mt-2 mb-0 rounded-3" role="alert">
										...
										<div class="avatar avatar-xs me-2">
											<img class="avatar-img rounded-circle" src="./silicon-front/silicon/09.jpg" alt="avatar">
										</div>
										<!-- Info -->
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end min-w-auto" data-bs-popper="none">
							...
							<li>
								<a class="dropdown-item" href="https://eduport.webestica.com/docs/index.html" target="_blank">
							...
							<li> <hr class="dropdown-divider"></li>
							<li>
								<a class="dropdown-item" href="https://eduport.webestica.com/docs/alerts.html" target="_blank">
					...
					<li class="px-3">
						<div class="d-flex align-items-center">
							...
							<div class="avatar me-3">
								<img class="avatar-img rounded-circle shadow" src="./silicon-front/silicon/01.jpg" alt="avatar">
							</div>
							<div>
		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
					...
					<!-- Video button -->
					<a data-glightbox="" data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" class="ms-0 ms-sm-4 d-block" savefrom_lm_index="0" savefrom_lm="1">
			...
			<div class="col-lg-7 col-xl-6 text-center position-relative">
				...
				<!-- Active student -->
				<div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style="background:url(silicon-front/assets/images/pattern/01.png) no-repeat center center; background-size:cover;">
					<p class="text-white">Our daily new students</p>
					<!-- Avatar group -->
					<ul class="avatar-group mb-0">
						<li class="avatar avatar-sm">
							<img class="avatar-img rounded-circle border-white" src="./silicon-front/silicon/01.jpg" alt="avatar">
						</li>
						<li class="avatar avatar-sm">
							<img class="avatar-img rounded-circle border-white" src="./silicon-front/silicon/02.jpg" alt="avatar">
						</li>
						<li class="avatar avatar-sm">
							<img class="avatar-img rounded-circle border-white" src="./silicon-front/silicon/03.jpg" alt="avatar">
						</li>
						<li class="avatar avatar-sm">
							<img class="avatar-img rounded-circle border-white" src="./silicon-front/silicon/04.jpg" alt="avatar">
						</li>
						<li class="avatar avatar-sm">
			...
			<div class="tab-pane fade show active" id="course-pills-tabs-1" role="tabpanel" aria-labelledby="course-pills-tab-1">
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/02(1).jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/03(1).jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/07.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/11.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-purple bg-opacity-10 text-purple">All level</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/12.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/04(1).jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-purple bg-opacity-10 text-purple">All level</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/09(1).jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-purple bg-opacity-10 text-purple">All level</a>
			...
			<div class="tab-pane fade" id="course-pills-tabs-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/05.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/06.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/10.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-info bg-opacity-10 text-info">Intermediate</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/13.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
			...
			<div class="tab-pane fade" id="course-pills-tabs-4" role="tabpanel" aria-labelledby="course-pills-tab-4">
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="./silicon-front/silicon/01(1).jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
		...
		<div class="row">
			...
			<div class="tiny-slider arrow-round arrow-blur arrow-hover">
				<div class="tns-outer" id="tns1-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">12 to 16</span>  of 4</div><div id="tns1-mw" class="tns-ovh"><div class="tns-inner" id="tns1-iw"><div class="tiny-slider-inner pb-1  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-autoplay="true" data-arrow="true" data-edge="2" data-dots="false" data-items="3" data-items-lg="2" data-items-sm="1" id="tns1" style="transform: translate3d(-66.6667%, 0px, 0px);"><div class="tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src="./silicon-front/silicon/04.jpg" alt="avatar">
										</div>
						...
						<div class="card action-trigger-hover border bg-transparent">
							<!-- Image -->
							<img src="./silicon-front/silicon/17.jpg" class="card-img-top" alt="course image">
							<!-- Card body -->
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-3">
							...
							<div class="card-footer pt-0 bg-transparent">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src="./silicon-front/silicon/09.jpg" alt="avatar">
										</div>
						...
						<div class="card action-trigger-hover border bg-transparent">
							<!-- Image -->
							<img src="./silicon-front/silicon/16.jpg" class="card-img-top" alt="course image">
							<!-- Card body -->
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-3">
							...
							<div class="card-footer pt-0 bg-transparent">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src="./silicon-front/silicon/01.jpg" alt="avatar">
										</div>
						...
						<div class="card action-trigger-hover border bg-transparent">
							<!-- Image -->
							<img src="./silicon-front/silicon/14.jpg" class="card-img-top" alt="course image">
							<!-- Ribbon -->
							...
							<div class="card-footer pt-0 bg-transparent">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<div class="d-flex align-items-center">
										<div class="avatar avatar-sm">
											<img class="avatar-img rounded-1" src="./silicon-front/silicon/10(1).jpg" alt="avatar">
										</div>
			...
			<div class="col-xl-7 order-2 order-xl-1">
					...
					<div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
						<div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
							...
							<div class="d-flex align-items-center">
								<!-- Avatar -->
								<div class="avatar avatar-sm">
									<img class="avatar-img rounded-1" src="./silicon-front/silicon/02.jpg" alt="avatar">
								</div>
								<!-- Info -->
								<div class="ms-2">
				...
				<div class="row mt-5 mt-xl-0">
					...
					<div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
						...
						<div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center" style="background:url(silicon-front/assets/images/pattern/02.png) no-repeat center center; background-size:cover;">
							<!-- Info -->
					...
					<div class="col-md-5 mt-n6 mb-0 mb-md-5">
						<div class="bg-body shadow text-center p-4 rounded-3">
							<!-- Avatar -->
							<div class="avatar avatar-xl mb-3">
								<img class="avatar-img rounded-circle" src="./silicon-front/silicon/03.jpg" alt="avatar">
							</div>
							<!-- Content -->
							<blockquote>
								<p>
							...
							<li class="list-inline-item">
								...
								<div class="dropup mt-0 text-center text-sm-end">
									...
									<ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="./silicon-front/silicon/uk.svg" alt="">English</a></li>
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="./silicon-front/silicon/gr.svg" alt="">German </a></li>
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="./silicon-front/silicon/sp.svg" alt="">French</a></li>
									</ul>
								</div>
							</li>
